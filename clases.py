...
class Estudiantes(object):
    def __init__(self,_cedula,_nombre,_apellido,_edad,_nota1,_nota2_,_nota3):
        self.cedula=_cedula
        self.nombre=_nombre
    ...
    def incluirEvento(self,_nota1,_nota2,_nota3):
        return ("modificación: Nota_1: {} Nota_2 {} Nota_3 {}".format(_nota1,_nota2,_nota3))
    def EntregaHistorial(self):
        print("No. Cedula: {} - {} {}".format(self.cedula,self.nombre,self.apellido))


def registrarEstudiante():
    print("Registro de estudantes\n")
...
def buscarEstudiante():
    ...
    cedula = int(input("Ingrese el número de cedula a buscar: "))
    for objAlumno in listaEstudiantes:
